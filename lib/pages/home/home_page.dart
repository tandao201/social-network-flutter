      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.home_outlined, color: AppColor.black,),
            backgroundColor: AppColor.white,
            label: "",
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.search_outlined, color: AppColor.black),
            backgroundColor: AppColor.white,
            label: "",
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.favorite_border_rounded, color: AppColor.black),
            backgroundColor: AppColor.white,
            label: "",
          ),
          BottomNavigationBarItem(
